...
```{r, fig.path=plotDir, dev=c("png", "cairo_pdf"), fig.height = 5.5, fig.width = 6}
...
```{r, Fig4F, fig.path=plotDir, dev=c("png", "cairo_pdf"), fig.height = 5, fig.width = 5}
...
```{r, Fig4G, fig.path=plotDir, dev=c("png", "cairo_pdf"), fig.width = 12, fig.height=10}
...
## Assemble Figure 4
```{r, fig.path=plotDir, dev=c("png", "cairo_pdf"), fig.height=17, fig.width=17, eval = TRUE}
...
ggsave("Fig4.pdf", height = 17, width= 17)
```
...
```{r, fig.path=plotDir, dev=c("png", "cairo_pdf"), fig.height=17, fig.width=15, eval = TRUE}
...
Fig4 <-
 ...
 wrap_elements( IL4inTrisomy12 )+ tp +
 wrap_elements( Fig4B )+ tp +
 wrap_elements( Fig4G )+ tp + 
 # wrap_elements( Fig4C )+ tp + 
 wrap_elements( Fig4E )+ tp + 
 ...
 wrap_elements( Fig4F )+ tp + 
  ...
  plot_annotation(tag_levels = "A", title="Figure 4", theme = theme(title=element_text(size = 20)))+
  plot_layout(design = design1, heights = c(1,1.3,1), width=c(2,.5,1.5))
...
```{r, fig.path=plotDir, dev=c("png", "cairo_pdf"), fig.height=20, fig.width=16, eval = TRUE}
...
Fig4 <-
 ...
 wrap_elements( Fig4F )+ tp + 
  ...
  plot_annotation(tag_levels = "A", title="Figure 4", theme = theme(title=element_text(size = 20)))+
  plot_layout(design = design1, heights = c(1,1.3,.6,.4), width=c(2,.5,1.5))
...
```{r, fig.path=plotDir, dev=c("png", "cairo_pdf"), fig.height=18, fig.width=14, eval = TRUE}
...
Fig4 <-
 ...
 wrap_elements( Fig4G )+ tp +
  ...
  plot_annotation(tag_levels = "A", title="Figure 4", theme = theme(title=element_text(size = 20)))+
  plot_layout(design = design1, heights = c(.8,1,1.1), width=c(1.7,.3,1))
