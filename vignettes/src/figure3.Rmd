...
```{r, Fig3A, fig.path=plotDir, dev=c("png", "pdf"), fig.height = 8, fig.width = 9.5, message = FALSE, warning = FALSE}
...
Assemble figure
```{r Fig3B, fig.path=plotDir, dev=c("png", "pdf"), fig.height=3, fig.width=8.5, message = FALSE, warning = FALSE}
...
# Assemble Figure
```{r, Fig3,  fig.path=plotDir, dev=c("png", "pdf"), fig.height=13, fig.width=20, message = FALSE, warning = FALSE}
...
ggsave(Fig3, device = "tiff", filename = "../../inst/figs/Fig3.tiff", width = 20, height = 13, units="in", dpi="screen")
```
