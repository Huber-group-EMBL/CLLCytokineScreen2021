...
## Arrange plots
```{r, Fig2, fig.path=plotDir,  dev=c("png", "cairo_pdf"), fig.width=16, fig.height=23, eval = TRUE, warning = FALSE}
...
ggsave(Figure2, device = cairo_pdf, filename = "../../inst/figs/Fig2.pdf", width = 16, height = 23, units="in", dpi="screen")
