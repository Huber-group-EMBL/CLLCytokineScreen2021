...
ggplot( Stim_PD.corr_all, aes(x=estimate.cor, y=-log10(p.value))) +
      ...
      geom_label_repel(aes(label=ifelse(p.value<0.05&abs(estimate.cor)>0.1,Cytokine,'')))+
      # scale_colour_manual(values=c(palblues[2], palreds[4], "black", "grey"))+
      t2 +
      labs(title="Correlation between CLL-PD and response to Stimuli", x = "Pearson Correlation coefficient", y = "-log10(adj p-val)")+
