...
author: "Cytokine Screen 2020: Holly Giles, Peter Bruch"
date: "`r doc_date()`"
output:
...
```{r Fig6B, fig.path=plotDir, dev=c("png", "pdf"), fig.width = 9, fig.height = 18, warning=FALSE}
...
```{r Fig6A, fig.path=plotDir, dev=c("png", "pdf"), fig.width = 10, fig.height = 10}
...
```{r, Fig6C, fig.path=plotDir, dev=c("png", "pdf"),  fig.width=9, fig.height=9}
...
```{r, Fig6D, fig.path=plotDir, dev=c("png", "pdf"),  fig.width=9, fig.height=9}
...
# Assemble Figure
```{r Fig6, fig.path=plotDir, dev=c("tiff"), fig.height = 24, fig.width = 22, warning=FALSE}
...
ggsave(Fig6, device = "tiff", filename = "../../inst/figs/Fig6.tiff", width = 22, height = 24, units="in")
