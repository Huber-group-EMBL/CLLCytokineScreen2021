...
## Fig 5A
Dummy plots
```{r, Fig5A,  fig.path=plotDir, dev=c("png", "pdf"), fig.width=8, fig.height=8}
...
```{r, Fig5B,  fig.path=plotDir, dev=c("png", "pdf"),fig.width=3, fig.height=6}
...
```{r Fig5C,  fig.path=plotDir, dev=c("png", "pdf"), fig.width=12, fig.height = 8, warning=FALSE}
...
## Fig 5D
```{r Fig5D,  fig.path=plotDir, dev=c("png", "pdf"), warning=FALSE}
...
## Fig 5E
```{r Fig5E,  fig.path=plotDir, dev=c("png", "pdf"), warning=FALSE}
...
## Fig 5F
```{r Fig5F,  fig.path=plotDir, dev=c("png", "pdf"), warning=FALSE}
...
## Fig 5G
```{r Fig5G,  fig.path=plotDir, dev=c("png", "pdf"), warning=FALSE}
...
## Fig 5H
```{r Fig5H,  fig.path=plotDir, dev=c("png", "pdf"), warning=FALSE}

wrap_plots(plotList$`treatment_drug:Ibrutinib:treatment_cytokine:CpG ODN`)
```

## Fig 5G
```{r Fig5I,  fig.path=plotDir, dev=c("png", "pdf"), warning=FALSE}
...
# Arrange plots
```{r,Fig5, fig.path=plotDir, dev=c("png", "pdf"),  fig.width=20, fig.height=22, warning=FALSE}
...
ggsave(Fig5, device = "tiff", filename = "../../inst/figs/Fig5.tiff", width = 20, height = 22, units="in", dpi="screen")
```
