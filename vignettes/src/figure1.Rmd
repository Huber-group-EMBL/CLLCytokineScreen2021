...
## Assemble Figure
```{r, Figure1, fig.height=11, fig.width=18, fig.path=plotDir, dev=c("png", "cairo_pdf"), message=FALSE, warning=FALSE}
...
Figure1 <-
  ...
  wrap_elements(Fig1F) + tp+
  
  plot_annotation(tag_levels = "A", title="Figure 1", theme = theme(title=element_text(size = 20))) +
  plot_layout(design = design1, heights = c(0.7,0.55,0.45), width=c(1,0.8,0.8,1))
