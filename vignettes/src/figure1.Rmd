...
```{r Fig1C, fig.path=plotDir, dev=c("png", "pdf"), fig.width=4, fig.height=3.5}
...
```{r Fig1D, fig.path=plotDir, dev=c("png", "pdf"), fig.width=7, fig.height=5}
...
```{r Fig1E, fig.path=plotDir, dev=c("png", "pdf"), fig.width=7, fig.height=5, message=FALSE, warning=FALSE}
...
# Assemble Figure
```{r, Fig1, fig.height=11, fig.width=18, fig.path=plotDir, dev=c("png", "pdf"), message=FALSE, warning=FALSE}
...
ggsave(patchwork_plot, device = "tiff", filename = "../../inst/figs/Fig1.tiff", width = 18, height = 11, units="in", dpi="screen")
