...
Drug_Cor_Plot<- Drug_Corr_tab %>% 
  ...
  geom_text(aes(label=ifelse(adj.p.value<0.05,sub("^(-?)0.", "\\1.", sprintf("%.2f", round(Pearson_R,2))),""), fontface = ifelse(adj.p.value<0.05, 1, 1)), size=5)+
    t_tmp+
...
Figure1 <-
  ...
  plot_layout(design = design1, heights = c(0.7,1.2), width=c(1,0.7,.9,1))
