...
```
## Appendix Table S1. Patient samples included in the study.
...
```
## Appendix Table S2. List of genetic features tested for their association with stimulus response in the univariate model of Figure 3A.
...
## Appendix Table S3. Survival analysis of microenvironmental response clusters comparing C3 to C1, C2 and C4.
...
## Appendix Table S4. Survival analysis of microenvironmental response clusters comparing C3 to C1 and C2 combined.
...
## Appendix Table S5. Multivariate survival analysis of response clusters.
...
## Appendix Table S6. Over-representation tests of immune signalling pathways (and control pathways) amongst Spi-B gene targets, based on primary CLL ATACseq data.
...
```
## Appendix Table S7. Over-representation tests of immune signalling pathways (and control pathways) amongst Spi-B gene targets, based on DLBCL ChIPseq data from Care et al. 2014^1^. 
...
## Appendix Figure S17. Chromosomal locations of Spi-B motifs that show differential accessibility between trisomy 12 and non-trisomy 12 CLL. 
