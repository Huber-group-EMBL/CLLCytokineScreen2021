...
**Appendix Table 2. List of genetic alterations tested for their association with stimuli response in the univariate model of Figure 3A** Only genetic alterations with at least 3 positive cases were considered. 
\newpage
...
**Appendix Table 3. Multivariate survival analysis of response clusters.** Multivariate Cox proportional hazards model of stimuli response clusters and genetic subgroups of disease progression using TTT and C3 as reference.
\newpage
...
```
**Appendix Table 5. Survival analysis of microenvironmental response clusters comparing Cluster 3 to the coombined Cluster 1 and 2.** 
