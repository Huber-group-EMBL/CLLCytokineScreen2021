...
```{r, fig.pos="H", fig.height=8, fig.width=16}
...
```{r, fig.pos="H", fig.width=11, fig.height=11}
...
```{r, fig.pos="H", fig.width=9, fig.height=10, warning=F, message=F}
...
```{r, dev=c("png", "cairo_pdf"), fig.height=7, fig.width=7}
...
Log normalized viability after treatment with resiquimod with and without ibrutinib. Faceted by IGHV mutation status and trisomy 12.
...
## Appendix Figure 16. ATACseq comparing trisomy 12 and non-trisomy 12 CLL samples, without including TF binding sites on chromosome 12.
