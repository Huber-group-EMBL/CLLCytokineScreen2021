...
Log transformed viabilities after treatment with drugs, faceted by cluster. BH-adjusted p-values from student's t-tests are shown (C1: n=77; C2:n=27; C3: n=38; C4: n=50).
...
Log2 fold changes are plotted of Spi-B binding sites that show an absolute Log2 fold change > 1 and a p value < 0.1, as calculated using the diffTF package for all Spi-B binding sites defined in the HOCOMOCO database. The Analysis is based on the data of Rendeiro et al. 2016^1^ (n=51).  
