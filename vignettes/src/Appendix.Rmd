...
## Appendix Figure 5. DNA Methylation profile of Clusters defined by response to microenvironmental stimuli
...
```{r S6, fig.path=plotDir, dev=c("png", "cairo_pdf"), fig.height=13, fig.width=13}
...
## Appendix Figure 6. The relationship between CLL Proliferative Drive (as defined by Lu et al. (2021)^2^) and microenvironmental response.
