...
## Appendix Table S5. Over-representation tests of immune signalling pathways amongst Spi-B and PU.1 gene targets, based on primary CLL ATACseq data.  Gene sets were selected from KEGG and Reactome databases. Control pathways i.e not related to immune signalling (Oxidative Phosphorylation, TP53 signalling and DNA Replication) were also included in the analysis and are not significant. 25 genes sets were tested, results for all genesets containing at least one target gene are shown.
...
## Appendix Table S6. Over-representation tests of immune signalling pathways amongst Spi-B and PU.1 gene targets, based on DLBCL ChIPseq data from Care et al. 2014^1^. Gene sets were selected from KEGG and Reactome databases. Control pathways i.e not related to immune signalling (Oxidative Phosphorylation, TP53 signalling and DNA Replication) were also included in the analysis and are not significant. 25 genesets were tested, all are shown.
