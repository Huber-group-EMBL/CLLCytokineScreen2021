...
```{r, Fig7A, fig.path=plotDir, dev=c("png", "pdf"), fig.width=7, fig.height=7}
...
```{r Fig7B, fig.path=plotDir, dev=c("png", "pdf"), fig.width=7, fig.height=7}
...
```{r Fig7C, fig.path=plotDir, dev=c("png", "pdf"), fig.width=6, fig.height=4}
...
```{r Fig7D, fig.path=plotDir, dev=c("png", "pdf"), fig.width=6, fig.height=4}
...
```{r Fig7E, fig.path=plotDir, dev=c("png", "pdf"), fig.width=6, fig.height=4}
...
```{r Fig7F, fig.path=plotDir, dev=c("png", "pdf"), fig.width=6, fig.height=4}
...
```{r, Fig7G, fig.path=plotDir, dev=c("png", "pdf"), fig.width=16, fig.height=7}
...
## Figure 7H
Kaplan-Meier curve to show associations of pSTAT6 levels with treatment free survival.   
```{r Fig7H, fig.path=plotDir, dev=c("png", "pdf"), fig.width=16, fig.height=7}
...
# Assemble Figure
```{r, Fig7, fig.path=plotDir, dev=c("png", "pdf"),fig.height=15, fig.width=16}
...
Fig7
 ...
 ggsave(Fig7, device = "tiff", filename = "../../inst/figs/Fig7.tiff", width = 16, height = 15, units="in", dpi="screen")
